...
const HTML_TAGS: ITagSet = {
  // The root element
  html: new HTMLTagSpecification('The html element represents the root of an HTML document.', ['manifest']),
  // Document metadata
  head: new HTMLTagSpecification('The head element represents a collection of metadata for the Document.'),
  ...
  link: new HTMLTagSpecification('The link element allows authors to link their document to other resources.', [
    'href',
    'crossorigin:xo',
    'rel',
    'media',
  ...
  // Sections
  body: new HTMLTagSpecification('The body element represents the content of the document.', [
    'onafterprint',
    'onbeforeprint',
    'onbeforeunload',
    'onhashchange',
  ...
  h1: new HTMLTagSpecification('The h1 element represents a section heading.'),
  h2: new HTMLTagSpecification('The h2 element represents a section heading.'),
  h3: new HTMLTagSpecification('The h3 element represents a section heading.'),
  h4: new HTMLTagSpecification('The h4 element represents a section heading.'),
  h5: new HTMLTagSpecification('The h5 element represents a section heading.'),
  h6: new HTMLTagSpecification('The h6 element represents a section heading.'),
  ...
  // Grouping content
  p: new HTMLTagSpecification('The p element represents a paragraph.'),
  ...
  em: new HTMLTagSpecification('The em element represents stress emphasis of its contents.'),
  strong: new HTMLTagSpecification('The strong element represents strong importance, seriousness, or urgency for its contents.'),
  small: new HTMLTagSpecification('The small element represents side comments such as small print.'),
  s: new HTMLTagSpecification('The s element represents contents that are no longer accurate or no longer relevant.'),
  cite: new HTMLTagSpecification(
    'The cite element represents a reference to a creative work. It must include the title of the work or the name of the author(person, people or organization or an URL reference, or a reference in abbreviated form as per the conventions used for the addition of citation metadata.'
  ),
  q: new HTMLTagSpecification('The q element represents some phrasing content quoted from another source.', ['cite']),
  ...
  samp: new HTMLTagSpecification('The samp element represents sample or quoted output from another program or computing system.'),
  kbd: new HTMLTagSpecification(
    'The kbd element represents user input (typically keyboard input, although it may also be used to represent other input, such as voice commands.'
  ),
  sub: new HTMLTagSpecification('The sub element represents a subscript.'),
  sup: new HTMLTagSpecification('The sup element represents a superscript.'),
  ...
  br: new HTMLTagSpecification('The br element represents a line break.'),
  wbr: new HTMLTagSpecification('The wbr element represents a line break opportunity.'),
  // Edits
  ins: new HTMLTagSpecification('The ins element represents an addition to the document.'),
  del: new HTMLTagSpecification('The del element represents a removal from the document.', ['cite', 'datetime']),
  // Embedded content
  picture: new HTMLTagSpecification(
    'The picture element is a container which provides multiple sources to its contained img element to allow authors to declaratively control or give hints to the user agent about which image resource to use, based on the screen pixel density, viewport size, image format, and other factors. It represents its children.'
  ),
  img: new HTMLTagSpecification('An img element represents an image.', [
    'alt',
    'src',
    'srcset',
    'crossorigin:xo',
  ...
  iframe: new HTMLTagSpecification('The iframe element represents a nested browsing context.', [
    'src',
    'srcdoc',
    'name',
    'sandbox:sb',
  ...
  video: new HTMLTagSpecification('A video element is used for playing videos or movies, and audio files with captions.', [
    'src',
    'crossorigin:xo',
    'poster',
    'preload:pl',
  ...
  audio: new HTMLTagSpecification('An audio element represents a sound or audio stream.', [
    'src',
    'crossorigin:xo',
    'preload:pl',
    'autoplay:v',
  ...
  // Tabular data
  table: new HTMLTagSpecification('The table element represents data with more than one dimension, in the form of a table.', [
    'sortable:v',
    'border'
  ]),
  ...
  td: new HTMLTagSpecification('The td element represents a data cell in a table.', ['colspan', 'rowspan', 'headers']),
  th: new HTMLTagSpecification('The th element represents a header cell in a table.', [
    'colspan',
    'rowspan',
    'headers',
    'scope:s',
  ...
  button: new HTMLTagSpecification('The button element represents a button labeled by its contents.', [
    'autofocus:v',
    'disabled:v',
    'form',
    'formaction',
  ...
  select: new HTMLTagSpecification('The select element represents a control for selecting amongst a set of options.', [
    'autocomplete:inputautocomplete',
    'autofocus:v',
    'disabled:v',
    'form',
  ...
  optgroup: new HTMLTagSpecification('The optgroup element represents a group of option elements with a common label.', [
    'disabled:v',
    'label'
  ]),
  ...
  fieldset: new HTMLTagSpecification('The fieldset element represents a set of form controls optionally grouped under a common name.', [
    'disabled:v',
    'form',
    'name'
  ]),
...
function collectValuesDefault(
  ...
  const processAttributes = (attributes: string[]) => {
    attributes.forEach(attr => {
      if (attr.length > prefix.length && _.startsWith(attr, prefix)) {
