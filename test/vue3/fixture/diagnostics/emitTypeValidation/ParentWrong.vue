...
export default defineComponent({
  ...
  setup() {
    const onNull = (a: never) => {}
    const onNon = (p: number) => {}
    const onOne = (a: boolean, b: string) => {}
    const onTwo = (a: boolean, b: string[], c: number) => {}
    const onRest = (...args: never[]) => {}
    const onFoo = (a: number) => {}
