...
describe('Should autocomplete', () => {
  const templateDocUri = getDocUri('client/completion/template/Template.vue');
  const templateFrameworkDocUri = getDocUri('client/completion/template/Template.Framework.vue');
